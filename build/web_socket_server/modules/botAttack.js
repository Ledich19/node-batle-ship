...
import { checkIsAliveShip, checkShoutResult, createKilledShip, createPoints, createShootOption, getRandomCeil, } from '../helpers/field.js';
import checkEnd from './checkEnd.js';
const botAttack = (ws) => {
    let isBotAction = true;
    const field = ws.room.fields[ws.userId];
    const points = [];
    if (!field || ws.room.currentPlayer !== BOT_ID)
        return;
    while (isBotAction) {
        let nextShot = null;
...
//# sourceMappingURL=botAttack.js.map